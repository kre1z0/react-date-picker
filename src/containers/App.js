          ...
          <div className="root-container">
            <div className="group">
              ...
              <DatePicker
                withTime={false}
                value={withTime}
                onChange={date => this.onPickDate(date, "withTime")}
              />
            </div>
            <div className="group">
              ...
              <DatePicker
                value={withOutTime}
                onChange={date => this.onPickDate(date, "withOutTime")}
              />
            </div>
            <div className="group">
              ...
              <DatePicker
                ...
                onChange={date => this.onPickDate(date, "withOffsetDate")}
              />
            </div>
            <div className="group">
              <div className="label">4) with disabled offset date</div>
              <DatePicker
                withOffsetDate
                disabledOffsetDate
                value={withDisabledOffsetDate}
                onChange={date => this.onPickDate(date, "withDisabledOffsetDate")}
              />
            </div>
            <div className="group">
              ...
              <div className="range">
                <DatePicker
                  ...
                  startDate={startDate}
                  endDate={endDate}
                  onChange={date => this.onPickDate(date, "startDate")}
                />
                ...
                <DatePicker
                  ...
                  startDate={startDate}
                  endDate={endDate}
                  onChange={date => this.onPickDate(date, "endDate")}
                />
              </div>
            </div>
          </div>
          <div className="button-group">
            <button className="button" onClick={this._pickCurrentDate}>
              current date
            </button>
            <button className="button" onClick={this._pickRandomDate}>
